-- lovable-cron-fallback-reviewed: scheduled marketing campaigns must start within minutes of their scheduled time; a 5-minute dispatcher is the only mechanism that meets that delivery window
