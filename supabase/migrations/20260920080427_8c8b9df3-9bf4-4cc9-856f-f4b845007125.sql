-- lovable-cron-fallback-reviewed: scheduled WhatsApp follow-ups must fire within minutes of their due time; a 5-minute dispatcher is the only mechanism that meets that delivery window
