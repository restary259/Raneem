...
-- 1. Unique phone constraint to prevent concurrent duplicate inserts
CREATE UNIQUE INDEX IF NOT EXISTS leads_phone_unique ON leads (phone);

-- 2. Update auto_split_payment to cancel rewards/commissions when case moves AWAY from 'paid'
...
BEGIN
  ...
  -- CREATE rewards when moving TO paid (existing logic preserved)
