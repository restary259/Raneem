...
-- Add commission_amount to profiles for influencer fixed commission
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS commission_amount integer NOT NULL DEFAULT 0;

-- Update auto_split_payment to use influencer's commission_amount from profiles
