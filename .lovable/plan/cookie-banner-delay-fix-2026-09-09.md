...
Make the cookie banner appear almost immediately on first visit, without blocking the first paint or interfering with the homepage hero load.and when you click accept the cookies it should accept immediately 
