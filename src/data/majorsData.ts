...
export const majorsData: MajorCategory[] = [
  {
    ...
    subMajors: [
      ...
      },
      {
        ...
        duration: '6 فصول دراسية',
        detailedDescription: 'المعلوماتية الحيوية تجمع بين علوم الحاسوب والأحياء لتحليل البيانات البيولوجية المعقدة. يتعلم الطلاب كيفية استخدام الخوارزميات والبرمجة لفهم الجينوم والبروتينات والعمليات الحيوية.',
        careerProspects: 'العمل في شركات الأدوية، المختبرات البحثية، مراكز الأبحاث الطبية، وتطوير التقنيات الطبية الحديثة.',
