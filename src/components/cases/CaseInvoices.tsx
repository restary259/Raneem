...
const CaseInvoices: React.FC<CaseInvoicesProps> = ({ caseId, canManage = false }) => {
  ...
  const fail = (e: any) =>
    toast({ variant: "destructive", description: e?.message ?? t("invoices.error") });
                ...
                <div className="space-y-2">
                  {openItemForm === invoice.id ? (
                    <div className="grid gap-2 sm:grid-cols-4 items-end">
                      <div className="sm:col-span-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setDraftItem((d) => ({ ...d, description: e.target.value }))
                          }
                          maxLength={200}
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setDraftItem((d) => ({ ...d, amount: e.target.value }))
                            }
                          />
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setDraftItem((d) => ({ ...d, quantity: e.target.value }))
                            }
                          />
                        </div>
                      </div>
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => setOpenItemForm(invoice.id)}
                      disabled={busy}
                    >
                      <Plus className="h-4 w-4 me-1" />
                      {t("invoices.addItem")}
