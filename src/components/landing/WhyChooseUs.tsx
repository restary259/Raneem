    ...
    <section id="why-us" className="py-12 md:py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-lg text-muted-foreground">{t('whyChooseUs.subtitle')}</p>
        </div>
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map((reason, index) => {
            ...
            return (
              <Card 
                key={index} 
                className="text-center p-6 bg-secondary border-transparent hover:shadow-2xl hover:-translate-y-2 hover:border-accent/20 transition-all duration-300 opacity-0 animate-fade-in"
