        ...
        <div className="container">
          ...
          <div className="mt-8 grid gap-4 pb-2 sm:grid-cols-2 lg:grid-cols-3">
            {nextStepRoutes.map((item, index) => {
              ...
              return <Link key={item.title} to={item.href} className={`group relative isolate flex min-h-40 min-w-0 flex-col overflow-hidden rounded-lg border border-story-foreground/15 p-5 text-story-foreground shadow-[inset_0_1px_0_hsl(var(--story-foreground)/0.3),0_5px_0_hsl(var(--foreground)/0.18),0_14px_26px_-12px_hsl(var(--foreground)/0.35)] transition-[transform,box-shadow] duration-300 hover:-translate-y-1 hover:shadow-[inset_0_1px_0_hsl(var(--story-foreground)/0.4),0_8px_0_hsl(var(--foreground)/0.18),0_20px_32px_-12px_hsl(var(--foreground)/0.4)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring active:translate-y-0 motion-reduce:transform-none motion-reduce:transition-none ${nextStepSurfaces[index] ?? "bg-story-sky"}`}>
                ...
                <span className="relative flex w-full items-start justify-between gap-3"><span className="grid size-11 shrink-0 place-items-center rounded-lg border border-story-foreground/20 bg-story-foreground/10 shadow-[inset_0_1px_1px_hsl(var(--story-foreground)/0.18),0_5px_12px_hsl(var(--foreground)/0.22)]"><Icon className="size-5" /></span><Arrow className="mt-1 size-4 shrink-0 transition-transform group-hover:translate-x-1 rtl:group-hover:-translate-x-1" /></span>
