        ...
        <div className="darb-header-main flex items-center justify-between" dir="ltr">
          ...
          <div className="hidden flex-shrink-0 items-center gap-2 xl:flex">
            ...
            >
             ...
             <Link
               to="/apply"
               className="inline-flex min-h-11 flex-shrink-0 items-center justify-center whitespace-nowrap rounded-full bg-highlight px-6 text-sm font-bold text-highlight-foreground shadow-surface transition-colors hover:bg-highlight/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
             >
              {t('nav.apply')}
            </Link>
          </div>
