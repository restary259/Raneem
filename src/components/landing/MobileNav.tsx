    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side={sheetSide} className="w-72" dir={dir}>
        <nav className="flex flex-col gap-3 mt-6 overflow-y-auto max-h-[calc(100dvh-4rem)]">
          ...
          <Link onClick={close} to="/quiz" className={`text-sm font-medium hover:text-brand-strong transition-colors ${textAlign} py-2`}>
            {t('nav.majorQuizNav')}
          </Link>
          <Link onClick={close} to="/resources" className={`text-sm font-medium hover:text-brand-strong transition-colors ${textAlign} py-2`}>
            {t('nav.resources')}
          </Link>
          ...
          <Collapsible open={moreOpen} onOpenChange={setMoreOpen} className="border-t pt-3 mt-3">
            ...
            <CollapsibleContent className="space-y-1 pt-1 animate-accordion-down">
              <Link onClick={close} to="/faq" className={`text-sm font-medium hover:text-brand-strong transition-colors ${textAlign} block py-2`}>
                {t('nav.faq')}
              </Link>
              <Link onClick={close} to="/educational-destinations" className={`text-sm font-medium hover:text-brand-strong transition-colors ${textAlign} block py-2`}>

                {t('nav.educationalDestinations')}
              </Link>
              <Link onClick={close} to="/partnership" className={`text-sm font-medium hover:text-brand-strong transition-colors ${textAlign} block py-2`}>
                {t('nav.partnership')}
              </Link>
              <Link onClick={close} to="/broadcast" className={`text-sm font-medium hover:text-brand-strong transition-colors ${textAlign} block py-2`}>
                {t('nav.broadcast')}
              </Link>
            </CollapsibleContent>
          </Collapsible>
          ...
          <Link
            onClick={close}
            to="/student-auth"
            className="bg-brand-strong text-brand-foreground px-3 py-2 rounded-lg font-medium hover:bg-brand-strong/90 transition-colors text-center mt-3 text-sm"
          >
            {t('nav.studentLogin')}
          </Link>
        </nav>
