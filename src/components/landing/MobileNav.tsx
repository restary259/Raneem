    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side={sheetSide} className="w-72 bg-background" dir={dir}>
        <nav className="flex flex-col gap-3 mt-6 overflow-y-auto max-h-[calc(100dvh-4rem)]">
          ...
          <Link onClick={close} to="/apply" className="inline-flex min-h-11 items-center justify-center rounded-full bg-brand px-4 text-center text-sm font-bold text-brand-foreground transition-colors hover:bg-brand/90">{t('hero.apply')}</Link>
