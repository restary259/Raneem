    ...
    <>
        ...
        <Card className="bg-gradient-to-r from-orange-500 to-orange-600 text-white border-0 shadow-xl">
          <CardContent className="p-4">
            <div className="flex items-start justify-between mb-3">
              ...
              <Button variant="ghost" size="sm" onClick={dismissPrompt} className="text-white hover:bg-white/20 p-1 h-auto">
                <X className="h-4 w-4" />
              </Button>
            </div>
            ...
            <div className="flex gap-2">
              ...
              <Button variant="ghost" onClick={dismissPrompt} className="text-white hover:bg-white/20 px-3">
                لاحقاً
              </Button>
            </div>
          </CardContent>
      ...
      <Dialog open={showIOSModal} onOpenChange={setShowIOSModal}>
        <DialogContent className="max-w-sm" dir="rtl">
          <DialogHeader>
            <DialogTitle className="text-center">تثبيت تطبيق درب على iOS</DialogTitle>
            <DialogDescription className="text-center">اتبع الخطوات التالية لإضافة التطبيق</DialogDescription>
          </DialogHeader>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground flex items-center gap-1">
                  ابحث عن أيقونة <Share className="h-4 w-4 inline" /> في شريط Safari
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">مرر للأسفل في القائمة حتى تجدها</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
          ...
          <Button onClick={() => { setShowIOSModal(false); dismissPrompt(); }} className="w-full bg-orange-500 hover:bg-orange-600">
            فهمت!
          </Button>
        </DialogContent>
      </Dialog>
