      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            {t('agentToolkit.teaser')}
          </p>
          <div className="mt-8 flex justify-center gap-8 text-primary">
            <div className="flex flex-col items-center gap-2">
                <Paperclip className="h-8 w-8"/>
                <span className="font-semibold">ملفات احترافية</span>
            </div>
            <div className="flex flex-col items-center gap-2">
                <Presentation className="h-8 w-8"/>
                <span className="font-semibold">دعم تسويقي</span>
            </div>
            <div className="flex flex-col items-center gap-2">
                <HelpCircle className="h-8 w-8"/>
                <span className="font-semibold">أسئلة شائعة</span>
            </div>
          </div>
          <div className="mt-10">
