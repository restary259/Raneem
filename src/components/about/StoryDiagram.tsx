        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="space-y-16 md:space-y-12">
            {storyPoints.map((point, index) => (
              <div key={index} className={`md:flex items-center ${index % 2 === 0 ? 'md:flex-row-reverse' : ''} mb-8 md:mb-0 group`}>
        ...
        <div className="text-center mt-16">
          <Card className="max-w-md mx-auto bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold mb-3">استكشف قصتنا بالتفصيل</h3>
              <p className="text-muted-foreground mb-4">
                تعرف على المزيد حول رحلتنا والأحداث المؤثرة التي شكلت هويتنا
              </p>
              <Button className="w-full" onClick={() => window.open('/about/full-story', '_blank')}>
                <ExternalLink className="h-4 w-4 mr-2" />
                القصة الكاملة
              </Button>
            </CardContent>
