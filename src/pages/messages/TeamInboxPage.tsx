...
export default function TeamInboxPage() {
  ...
  return (
    // The dashboard <main> is a block scroller, so flex-1 alone cannot bound
    ...
    <Tabs value={tab} onValueChange={changeTab} className="flex h-full min-h-0 min-w-0 flex-col gap-0 overflow-hidden">
      ...
      <TabsContent value="messages" className="m-0 flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
