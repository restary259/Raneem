...
const AdminSettingsPage = () => {
  ...
  const handleDataReset = async () => {
    ...
    try {
      ...
      toast({
        title: isRtl
          ? "✅ تم مسح البيانات التشغيلية — الحسابات محفوظة"
          : "✅ Operational data purged — all accounts preserved",
      });
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">
                  {t("admin.settings.platformTitle", "Platform Configuration")}
                </CardTitle>
              </CardHeader>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setSettings((s) => (s ? { ...s, forgotten_new_case_days: Number(e.target.value) } : s))
                      }
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setSettings((s) => (s ? { ...s, forgotten_contacted_days: Number(e.target.value) } : s))
                      }
                    />
                  </div>
                </div>
                ...
                <div className="space-y-3 pt-2">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      ...
                      <Input
                        value={contactForm.name_ar}
                        onChange={(e) => setContactForm((f) => ({ ...f, name_ar: e.target.value }))}
                      />
                    </div>
                    <div className="space-y-1">
                      <Label>{isRtl ? "الاسم إنجليزي" : "English Name"}</Label>
                      <Input
                        value={contactForm.name_en}
                        onChange={(e) => setContactForm((f) => ({ ...f, name_en: e.target.value }))}
                      />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      ...
                      <Input
                        value={contactForm.role_ar}
                        onChange={(e) => setContactForm((f) => ({ ...f, role_ar: e.target.value }))}
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        onChange={(e) => setContactForm((f) => ({ ...f, role_en: e.target.value }))}
                      />
                    </div>
                  </div>
                  <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => setContactForm((f) => ({ ...f, category: v }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
            ...
            <CardContent className="space-y-4">
              <div className="p-4 rounded-lg bg-destructive/10 border border-destructive/30 space-y-2">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  {isRtl
                    ? "سيتم الاحتفاظ ببيانات الإعداد فقط (البرامج، السكن، الإعدادات)."
                    : "Configuration data (programs, accommodations, settings) will be preserved."}
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div>
                  <Label className="text-destructive">
                    {isRtl ? 'اكتب "RESET" للتأكيد' : 'Type "RESET" to confirm'}
                  </Label>
                  <Input
