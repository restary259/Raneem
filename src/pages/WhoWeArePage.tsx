...
const WhoWeArePage = () => {
  ...
  return <div className="flex flex-col min-h-screen bg-background text-foreground" dir="rtl" lang="ar">
            <Header />
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="relative max-w-5xl mx-auto">
                            ...
                            <div className="space-y-16 md:space-y-0">
                                {storyPoints.map((point, index) => <div key={index} className={`md:flex items-center ${index % 2 === 0 ? 'md:flex-row-reverse' : ''} mb-8 md:mb-0`}>
                ...
                <section className="py-16 md:py-24 bg-secondary/20">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                            {ourValues.map((value, index) => <div key={value.title} className="text-center p-6 rounded-lg transition-all duration-300 animate-fade-in group hover:bg-card hover:shadow-lg" style={{
                ...
                <section className="py-16 md:py-24 bg-background">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                            {features.map((feature, index) => <Card key={feature.title} className="text-center transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-card animate-fade-in border-b-4 border-transparent hover:border-accent" style={{
