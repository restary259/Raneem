        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              {t("partner.earnings.studentCount", { n: rewards.length, count: rewards.length })}
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              {t("partner.earnings.studentCount", { n: pendingRewards.length + approvedRewards.length, count: pendingRewards.length + approvedRewards.length })}
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              {t("partner.earnings.studentCount", { n: paidRewards.length, count: paidRewards.length })}
            </p>
          </CardContent>
        </Card>
      </div>
