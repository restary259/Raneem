...
export const ALLOWED_TRANSITIONS: Record<CaseStatus, CaseStatus[]> = {
  ...
  [CaseStatus.APPT_SCHEDULED]: [CaseStatus.APPT_COMPLETED, CaseStatus.APPT_WAITING],
  [CaseStatus.APPT_WAITING]: [CaseStatus.APPT_SCHEDULED, CaseStatus.APPT_COMPLETED],
